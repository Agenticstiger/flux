...
<template>
  <div class="ff-404">
    ...
    <nav class="ff-404__cards" aria-label="Suggested destinations">
      <a class="ff-404__card" href="/flux/">
        <span class="ff-404__card-eyebrow">Start here</span>
        <strong>Home</strong>
        <span class="ff-404__card-detail">What FLUX is, in 60 seconds.</span>
      </a>
      <a class="ff-404__card" href="/flux/guide/">
      ...
      <a class="ff-404__card" href="/flux/schema/anatomy">
      ...
      <a class="ff-404__card" href="/flux/examples/">
    ...
    <p class="ff-404__report">
      ...
      <a href="https://github.com/Agenticstiger/flux/issues/new" rel="noopener">open an issue</a>
