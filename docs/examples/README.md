...
| `persona.flux.yml` | Persona | the pragmatic family subscriber, traits + worldview |
...
| `experiment.flux.yml` | Experiment | 50/50 A/B, largest-remainder assignment, Ossie metric |
...
| `simulation.flux.yml` | Simulation | the root: fidelity, golden digest, skills — and the seam |
