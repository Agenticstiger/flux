...
from validate import Bundle, load_yaml_docs  # noqa: E402
...
SCHEMA_PATH = REPO / "schema" / "flux-schema-latest.json"
MANIFEST_SCHEMA_PATH = REPO / "schema" / "flux-manifest-0.5.0.json"
